          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ajouter ou Modifier un Ordre de Paiement</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Sélectionner Un Compte Sélectionner Un Budget Sélectionner un Exercie</h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Imputation*</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control">
                      ...
                      <div class="form-group">
					    ...
					    <div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
                      	...
                      	<div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
	                        ...
	                        <select class="form-control">
                            <option>Selectionner un Mode de Réglement</option>
                            <option>Option one</option>
                            <option>Option two</option>
                            <option>Option three</option>
                          </select>
                      ...
                      <div class="form-group">
					    ...
					    <div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
                      	...
                      	<div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
	                        ...
	                        <select class="form-control">
                            <option>Selectionner une Personne physique</option>
                            <option>Option one</option>
                            <option>Option two</option>
                            <option>Option three</option>
                          </select>
                      ...
                      <div class="form-group">
                        <div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
                       		<label>Selectionner une Nature OP</label>
	                        <select class="form-control">
                            <option>Selectionner un Budget</option>
                            <option>Option one</option>
                            <option>Option two</option>
					    ...
					    <div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
					    	<label>Numero engagement</label>
	                        <input type="text" class="form-control" id="inputSuccess5" placeholder="Phone">
	                        <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                      	</div>

                      	<div class="col-md-4 col-sm-12 col-xs-12 form-group has-feedback">
                       		<label>Programme d'Emploi</label>
	                        <input type="checkbox"> 
                      	</div>
                      </div>
